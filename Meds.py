...
def tablet_list():
    ...
    showtabletwinpic = ImageTk.PhotoImage(Image.open("E:\\NK programs\\Python\\python save\\Meds\\Meds_front.png"))
...
def update_table():
    ...
    upwin.state('zoomed')
    upwinpic=ImageTk.PhotoImage(Image.open("E:\\NK programs\\Python\\python save\\Meds\\Meds_front.png"))
    ...
    def update_suggestions(event):
        ...
        if matching_tablets:
            ...
            suggestion_label.place(x=500, y=280)
        else:
    ...
    def update_suggestions2(event):
        ...
        if matching_tablets2:
            ...
            suggestion_label2.place(x=1070, y=280)
        else:
...
def insert_page():
    ...
    insertwinpic = ImageTk.PhotoImage(Image.open("E:\\NK programs\\Python\\python save\\Meds\\Meds_front.png"))
...
def bill():
    ...
    billwinpic = ImageTk.PhotoImage(Image.open("E:\\NK programs\\Python\\python save\\Meds\\Meds_front.png"))
...
def history():
    ...
    historywinpic = ImageTk.PhotoImage(Image.open("E:\\NK programs\\Python\\python save\\Meds\\Meds_front.png"))
...
homepic=ImageTk.PhotoImage(Image.open("E:\\NK programs\\Python\\python save\\Meds\\Meds_front.png"))
