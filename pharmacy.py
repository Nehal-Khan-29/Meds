...
def update_table():
    ...
    def ups():
        ...
        if ups:
            ...
            messagebox.showerror('error',"tablet record is not uppdated")
    ...
    Label(upwin, text="Edit Tablet", width=20).place(x=270, y=200)
    ...
    data = mycur.fetchall()
    tab_label = tk.Label(upwin, text="Tablet Name", width=20)
    ...
    label = Label(upwin, text="Col. to change", width=20)
    label.place(x=200, y=400)
    

    old = tk.StringVar()
    options = ["Select","id", "tablet_name", "availability","cost"]
    ttk.Combobox(upwin, textvariable=old, values=options).place(x=370, y=400)
    old.set(options[0])
    ...
    Label(upwin, text="Delete Tablet", width=20).place(x=900, y=200)
    
    label2 = Label(upwin, text="Tablet Name", width=20)
...
Tablet_Name
Availability
Cost''', width=20).place(x=500, y=100)
...
def bill():
    ...
    Label(billwin, text="Name:", width=20).place(x=200, y=200)
    name = Entry(billwin)
    name.place(x=370, y=200)
    name.config(borderwidth=2, relief='sunken')
    
    Label(billwin, text="Phone:", width=20).place(x=200, y=250)
    ph = Entry(billwin)
    ph.place(x=370, y=250)
    ph.config(borderwidth=2, relief='sunken')
    
    Label(billwin, text="Enter Tablet : ", width=20).place(x=200, y=300)
    ...
    def update_suggestions3(event):
        ...
        if matching_tablets3:
            ...
            suggestion_label3.place(x=370, y=320)
        else:
    ...
    Label(billwin, text="Enter Quantity : ", width=20).place(x=200, y=450)
    qt_entry = Entry(billwin)
    qt_entry.place(x=370, y=450)
    ...
    Button(billwin, text="Add Tablet", command=add_rec).place(x=500, y=450)
    Button(billwin, text="Remove Tablet", command=remove_rec).place(x=600, y=450)
    Button(billwin, text="Pay", command=pay).place(x=800, y=500)
    billwin.mainloop()
...
homepic=ImageTk.PhotoImage(Image.open("E:\\NK programs\\Python\\python save\\Pharmacy\\Pharmacy_front.png"))
...
Button(home,text='Bill',font=('Arial',20),command=bill,height=1,width=16,bg='Lightsteelblue2',
       fg='gray6',activebackground='Skyblue',activeforeground='thistle1').place(x=400,y=250)
Button(home,text='Customer History',font=('Arial',20),command=history,height=1,width=16,bg='Lightsteelblue2',
       fg='gray6',activebackground='Skyblue',activeforeground='thistle1').place(x=400,y=350)


Button(home,text='Show Tablets',font=('Arial',20),command=tablet_list,height=1,width=16,bg='Lightsteelblue2',
       fg='gray6',activebackground='Skyblue',activeforeground='thistle1').place(x=850,y=250)
Button(home,text='Edit Tablets',font=('Arial',20),command=update_table,height=1,width=16,bg='Lightsteelblue2',
       fg='gray6',activebackground='Skyblue',activeforeground='thistle1').place(x=850,y=350)
Button(home,text='Add Tablets',font=('Arial',20),command=insert_page,height=1,width=16,bg='Lightsteelblue2',
